...
class Book(models.Model):
    ...
    total_paid=models.CharField(_('total_paid'),max_length=255,blank=True,null=True)
    ad_ons=models.CharField(_('ad_ons'),max_length=255,blank=True,null=True)
    ad_discount=models.CharField(_('ad_discount'),max_length=255,blank=True,null=True)
    ad_ons_total=models.CharField(_('ad_ons_total'),max_length=255,blank=True,null=True)
    ad_discount_total=models.CharField(_('ad_ons_total'),max_length=255,blank=True,null=True)
    ad_other=models.CharField(_('ad_other'),max_length=255,blank=True,null=True)
    ad_other_total=models.CharField(_('ad_other_total'),max_length=255,blank=True,null=True)
    ...
    checkin_time=models.CharField(_('checkin_time'),max_length=255,blank=True,null=True)
    checkout_time=models.CharField(_('checkout_time'),max_length=255,blank=True,null=True)
